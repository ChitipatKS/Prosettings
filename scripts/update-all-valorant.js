...
async function run() {
  console.log("Fetching all VALORANT players missing real names...");
  ...
  console.log(`Found ${players.length} VALORANT players in our database missing real names.`);
  if (players.length === 0) {
    console.log("No VALORANT players missing real names. Exiting.");
    process.exit(0);
  }
